...
def test_apply_fuzzy(core_impl) -> None:  # type:ignore
    if TYPE_CHECKING:
        from ottype import core as core_impl
    ...
    for _ in range(FUZZY_TEST_COUNT):
        ...
        random_ot_raw_list = utils.make_random_ots(normalize, doc, FUZZY_TEST_OTS_LENGTH)
...
def test_inverse_apply_fuzzy(core_impl) -> None:  # type:ignore
    if TYPE_CHECKING:
        from ottype import core as core_impl
...
def test_transform_fuzzy(core_impl) -> None:  # type:ignore
    if TYPE_CHECKING:
        from ottype import core as core_impl
    ...
    for _ in range(FUZZY_TEST_COUNT):
        doc = utils.make_random_doc(FUZZY_TEST_INIT_DOC_LENGTH)
        random_ot_raw_list_1 = utils.make_random_ots(normalize, doc, FUZZY_TEST_OTS_LENGTH)
        random_ot_raw_list_2 = utils.make_random_ots(normalize, doc, FUZZY_TEST_OTS_LENGTH)
...
def test_compose_fuzzy(core_impl) -> None:  # type:ignore
    if TYPE_CHECKING:
        from ottype import core as core_impl
    ...
    for _ in range(FUZZY_TEST_COUNT):
        ...
        random_ot_raw_list_1 = utils.make_random_ots(normalize, doc_1, FUZZY_TEST_OTS_LENGTH)

        doc_2 = apply(doc_1, random_ot_raw_list_1)
        random_ot_raw_list_2 = utils.make_random_ots(normalize, doc_2, FUZZY_TEST_OTS_LENGTH)
